...
init -1 python hide:
    ...
    config.window_title = u"Carpe Diem"
    config.windows_icon = "images/aicon.png"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Carpe Diem"
    config.version = "2.2"
    config.steam_appid = "423880"
    ...
    #style.window.background = Frame("images/frame.png", 12, 12)
    ...
    style.menu_choice_button.background = Frame("images/GUI/choice_inactive.png")
    style.menu_choice_button.hover_background = Frame("images/GUI/choice_active.png")
    ...
    config.main_menu_music = "bgm/Title.mp3"
    ...
    config.enter_yesno_transition = Dissolve(0.5)

    ## Used when the yesno is hidden.
    config.exit_yesno_transition = Dissolve(0.5)

    ## Used when entering a replay
    config.enter_replay_transition = Dissolve(0.5)

    ## Used when exiting a replay
    config.exit_replay_transition = Dissolve(0.5)
...
python early:
    config.save_directory = "Carpe Diem-1438651883"
...
init python:
    ...
    build.executable_name = "Carpe Diem"
    ...
    # Itch
    build.itch_project = "moonlitworks/carpe-diem"
