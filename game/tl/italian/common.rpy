# TODO: Translation updated at 2015-12-23 13:23
...
translate italian strings:
    ...
    new "%(version)s console, originariamente creato da Shiz, C, e delta.\n"
    ...
    new "Ren'Py script abilitato."

    # renpy/common/00console.rpy:186
    old "Ren'Py script disabled."
    new "Ren'Py script disabilitato."
    ...
    new " <renpy script statement>: esegui lo statement\n"

    # renpy/common/00console.rpy:409
    old " <python expression or statement>: run the expression or statement"
    new " <python expression or statement>: esegui la expression o lo statement"
    ...
    new "load <slot>: carica il gioco da slot"
    ...
    new "watch <expression>: guarda una python expression"

    # renpy/common/00console.rpy:487
    old "unwatch <expression>: stop watching an expression"
    new "unwatch <expression>: smetti di guardare la expression"

    # renpy/common/00console.rpy:513
    old "unwatchall: stop watching all expressions"
    new "unwatchall: smetti di guardare tutte le expressions"

    # renpy/common/00console.rpy:530
    old "jump <label>: jumps to label"
    new "jump <label>: salta a livello"
...
translate italian strings:
    ...
    new "Forza Renderizzazzione Angle/Directx"

    # renpy/common/00gltest.rpy:81
    old "Force OpenGL Renderer"
    new "Forza Renderizzazzione OpenGL"

    # renpy/common/00gltest.rpy:85
    old "Force Software Renderer"
    new "Forza Renderizzazzione software"
    ...
    new "I cambiamenti avranno effetto al prossimo riavvio del programma."
    ...
    new "Questo computer sta usando la renderizzazzione software."

    # renpy/common/00gltest.rpy:157
    old "This computer is not using shaders."
    new "Questo computer non sta usando shaders."

    # renpy/common/00gltest.rpy:159
    old "This computer is displaying graphics slowly."
    new "Questo computer sta mostrando lentamente la grafica."

    # renpy/common/00gltest.rpy:161
    old "This computer has a problem displaying graphics: [problem]."
    new "Questo computer ha un problema nel mostrare la grafica: [problem]."

    # renpy/common/00gltest.rpy:166
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display. Updating DirectX could fix this problem."
    new "I driver grafici potrebbero essere non aggiornati o non correttamente funzionanti. Questo può portare a mostrare rallentamenti o errori grafici. Aggiornare DirectX potrebbe sistemare il problema."

    # renpy/common/00gltest.rpy:168
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "I driver grafici potrebbero essere non aggiornati o non correttamente funzionanti. Questo può portare a mostrare rallentamenti o errori grafici."
    ...
    new "L'installazione di web DirectX è iniziata. Potrebbe iniziare ridotto ad icona nella taskbar. Perfavore segui le istruzioni a schermo per installare DirectX."

    # renpy/common/00gltest.rpy:217
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}Note:{/b} Il programma di installazione DirectX web potrebbe installare, di base, la toolbar di Bing. Se non la si desidera, deselezionarlo nell'apposito box."

    # renpy/common/00gltest.rpy:221
    old "When setup finishes, please click below to restart this program."
    new "Quando l'installazione finisce, perfavore clicca qui sotto per riavviare il programma."
...
translate italian strings:
    ...
    new "Vuoi eliminare questo salvataggio?"

    # renpy/common/00layout.rpy:446
    old "Are you sure you want to overwrite your save?"
    new "Vuoi sovrascrivere il tuo salvataggio?"
    ...
    new "Vuoi tornare al menu principale?\nQuesto causa la perdita di progressi non salvati."

    # renpy/common/00layout.rpy:450
    old "Are you sure you want to begin skipping?"
    new "Vuoi iniziare a saltare?"

    # renpy/common/00layout.rpy:451
    old "Are you sure you want to skip to the next choice?"
    new "Vuoi saltare alla prossima scelta?"

    # renpy/common/00layout.rpy:452
    old "Are you sure you want to skip to unseen dialogue or the next choice?"
    new "Vuoi saltare al dialogo non visto o alla prossima scena?"
...
translate italian strings:
    ...
    new "Appunti vocali abilitati. Premi 'shift+C' per disabilitare."
...
translate italian strings:
    ...
    new "Aggiornatore di Ren'Py non supportato su dispositivi mobili."

    # renpy/common/00updater.rpy:481
    old "An error is being simulated."
    new "Un errore sta per essere simulato."

    # renpy/common/00updater.rpy:657
    old "Either this project does not support updating, or the update status file was deleted."
    new "Questo progetto non supporta aggiornamenti, o il file di stato dell'aggiornamento è stato eliminato."
    ...
    new "Questo account non ha i permessi di scrivere un log dell'aggiornamento."

    # renpy/common/00updater.rpy:699
    old "Could not verify update signature."
    new "Non posso verificare la firma dell'aggiornamento."
    ...
    new "Il file di aggiornamento potrebbe essere corrotto."

    # renpy/common/00updater.rpy:1044
    old "While unpacking {}, unknown type {}."
    new "Durante la decompressione {}, Tipo sconosciuto {}."
    ...
    new "Preparamento al download degli aggiornamenti."

    # renpy/common/00updater.rpy:1410
    old "Downloading the updates."
    new "Scaricamento aggiornamenti."
    ...
    new "Aggiornamenti installati. Il programma si riavvierà."

    # renpy/common/00updater.rpy:1418
    old "The updates have been installed."
    new "Aggiornamenti installati."

    # renpy/common/00updater.rpy:1420
    old "The updates were cancelled."
    new "Aggiornamenti cancellati."
...
translate italian strings:
    ...
    new "Ispezionando lo stile di [displayable_name!q]"
    ...
    new "        (nessuna proprietà influenza la mostrabilità)"

    # renpy/common/_developer/inspector.rpym:164
    old "        (default properties omitted)"
    new "        (Proprietà di default omessa)"
...
translate italian strings:
    ...
    new "Tentativo di rollback ad un tempo precedente, permettendoti di salvare o scegliere in modo differente."
    ...
    new "Ignora l'eccezione, permettendoti di continuare. Questo spesso porta ad altri errori."
    ...
    new "Ricarica il gioco dal disco, salvando e ripristinando il gioco se possibile."

    # renpy/common/_errorhandling.rpym:540
    old "Open Traceback"
    new "Apri tracciamento"
    ...
    new "Apri errori analisi"

    # renpy/common/_errorhandling.rpym:609
    old "Opens the errors.txt file in a text editor."
    new "Apri il file errors.txt in un editor di testo."
...
# TODO: Translation updated at 2019-11-27 11:28
