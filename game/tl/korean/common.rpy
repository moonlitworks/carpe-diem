# TODO: Translation updated at 2015-12-12 02:33

translate korean python:
    style.default.font = "SeoulNamsanM.ttf"
...
translate korean strings:
    ...
    new "버전 %(version), 원작 Shiz, C, and delta.\n"

    # renpy/common/00console.rpy:180
    old "Press <esc> to exit console. Type help for help.\n"
    new "ESC를 눌러 콘솔을 나갑니다. Help로 도움말을 보실 수 있습니다. \n"

    # renpy/common/00console.rpy:184
    old "Ren'Py script enabled."
    new "Ren'Py 스크립트 사용 가능."

    # renpy/common/00console.rpy:186
    old "Ren'Py script disabled."
    new "Ren'Py 스크립트 사용 불가."
...
translate korean strings:
    ...
    new "클립보드 활성화. Shift+C로 삭제."

    # renpy/common/00preferences.rpy:372
    old "Self-voicing enabled. Press 'v' to disable."
    new "자동 음성 모드가 실행되었습니다. v로 종료합니다."
...
translate korean strings:
    ...
    new "traceback.txt을 클립하여 클립보드로 복사합니다."
    ...
    new "errors.txt를 텍스트 에디터로 엽니다."

    # renpy/common/_errorhandling.rpym:614
    old "Copies the errors.txt file to the clipboard."
    new "errors.txt을 클립보드로 복사합니다."
...
# TODO: Translation updated at 2019-11-27 11:25
