# TODO: Translation updated at 2015-12-12 00:41
...
translate russian strings:
    ...
    new "Выберете геймпад для калибровки"

    # renpy/common/00gamepad.rpy:35
    old "No Gamepads Available"
    new "Геймпада не обнаружено"
...
translate russian strings:
    ...
    new "Изменения будут применены при следующем запуске."
...
translate russian strings:
    ...
    new "При загрузке несохраненный прогресс будет утерян.\nВы уверены, что хотите продолжить?"
    ...
    new "Вы уверены, что хотите пропустить текст до следующего выбора?"
...
# TODO: Translation updated at 2019-11-27 11:03
