# TODO: Translation updated at 2015-12-14 08:45
...
translate swedish strings:
    ...
    new "%(version)s konsol, ursprungligen av Shiz, C och delta.\n"

    # renpy/common/00console.rpy:180
    old "Press <esc> to exit console. Type help for help.\n"
    new "Tryck på <esc> för att stänga konsolen. Skriv help för hjälp.\n"

    # renpy/common/00console.rpy:184
    old "Ren'Py script enabled."
    new "Ren'Py skript aktiverad."

    # renpy/common/00console.rpy:186
    old "Ren'Py script disabled."
    new "Ren'Py skript avaktiverad."

    # renpy/common/00console.rpy:392
    old "help: show this help"
    new "help: visa denna hjälp"
    ...
    new "<renpy script statement>: kör påståendet\n"

    # renpy/common/00console.rpy:409
    old " <python expression or statement>: run the expression or statement"
    new "<python expression or statement>: kör uttrycket eller påståendet"

    # renpy/common/00console.rpy:417
    old "clear: clear the console history"
    new "clear: töm konsolens historik"

    # renpy/common/00console.rpy:421
    old "exit: exit the console"
    new "exit: stäng konsolen"

    # renpy/common/00console.rpy:429
    old "load <slot>: loads the game from slot"
    new "load <slot>: laddar det sparade spelet i spår"

    # renpy/common/00console.rpy:442
    old "save <slot>: saves the game in slot"
    new "save <slot>: sparar spelet i spår"

    # renpy/common/00console.rpy:453
    old "reload: reloads the game, refreshing the scripts"
    new "reload: laddar om spelet och uppdaterar skripten"

    # renpy/common/00console.rpy:461
    old "watch <expression>: watch a python expression"
    new "watch <expression>: kolla på ett pythonuttryck"

    # renpy/common/00console.rpy:487
    old "unwatch <expression>: stop watching an expression"
    new "unwatch <expression>: sluta kolla på ett uttryck"

    # renpy/common/00console.rpy:513
    old "unwatchall: stop watching all expressions"
    new "unwatchall: sluta kolla på alla uttryck"

    # renpy/common/00console.rpy:530
    old "jump <label>: jumps to label"
    new "jump <label>: hoppar till etikett"
...
translate swedish strings:
    ...
    new "Välj spelkontroll att kalibrera"

    # renpy/common/00gamepad.rpy:35
    old "No Gamepads Available"
    new "Inga spelkontroller tillgängliga"
    ...
    new "Tryck eller rör på [control!r] [kind]."
...
translate swedish strings:
    ...
    new "Tvinga Angle-/DirectX-renderare"

    # renpy/common/00gltest.rpy:81
    old "Force OpenGL Renderer"
    new "Tvinga OpenGL-renderare"

    # renpy/common/00gltest.rpy:85
    old "Force Software Renderer"
    new "Tvinga mjukvaru-renderare"
    ...
    new "Ändringar kommer ta effekt nästa gång detta program startas."

    # renpy/common/00gltest.rpy:150
    old "Performance Warning"
    new "Prestandavarning"

    # renpy/common/00gltest.rpy:155
    old "This computer is using software rendering."
    new "Denna dator använder mjukvaru-rendering."

    # renpy/common/00gltest.rpy:157
    old "This computer is not using shaders."
    new "Denna dator använder inte shaders."

    # renpy/common/00gltest.rpy:159
    old "This computer is displaying graphics slowly."
    new "Denna dator visar grafik långsamt."

    # renpy/common/00gltest.rpy:161
    old "This computer has a problem displaying graphics: [problem]."
    new "Denna dator har ett problem att visa grafik: [problem]."

    # renpy/common/00gltest.rpy:166
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display. Updating DirectX could fix this problem."
    new "Grafikdrivrutinerna kan vara utdaterade eller inte fungera korrekt. Detta kan leda till långsam eller fel grafikvisning. Uppdatering av DirectX kan möjligen fixa detta problem."

    # renpy/common/00gltest.rpy:168
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Grafikdrivrutinerna kan vara utdaterade eller inte fungera korrekt. Detta kan leda till långsam eller fel grafikvisning."

    # renpy/common/00gltest.rpy:173
    old "Update DirectX"
    new "Uppdatera DirectX"
    ...
    new "Fortsätt, Visa inte denna varning igen"

    # renpy/common/00gltest.rpy:209
    old "Updating DirectX."
    new "Uppdaterar DirectX."

    # renpy/common/00gltest.rpy:213
    old "DirectX web setup has been started. It may start minimized in the taskbar. Please follow the prompts to install DirectX."
    new "DirectX webbinstallation har startats. Det kan starta minimerat i aktivitetsfältet. Vänligen följ instruktionerna för att installera DirectX."

    # renpy/common/00gltest.rpy:217
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}Notering:{/b} Microsoft DirectX webbinstallation kommer, som standard, installera Bing till verktygsfältet. Om du inte vill detta, avmarkera lämplig ruta."

    # renpy/common/00gltest.rpy:221
    old "When setup finishes, please click below to restart this program."
    new "När installation avslutas, vänligen klicka nedan för att starta om detta program."
...
translate swedish strings:
    ...
    new "Är du säker på att du vill radera denna sparning?"
    ...
    new "Osparad framgång förloras vid laddning.\nÄr du säker på att du vill detta?"

    # renpy/common/00layout.rpy:448
    old "Are you sure you want to quit?"
    new "Är du säker på att du vill avsluta?"

    # renpy/common/00layout.rpy:449
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "Är du säker på att du vill återvända till huvudmenyn?\nOsparad framgång kommer förloras."

    # renpy/common/00layout.rpy:450
    old "Are you sure you want to begin skipping?"
    new "Är du säker på att du vill starta hoppa över?"
    ...
    new "Är du säker på att du vill hoppa över osedda meddelanden eller nästa val?"
...
translate swedish strings:
    ...
    old "Skip Mode"
    new "Överhoppningsläge"

    # renpy/common/00library.rpy:160
    old "Fast Skip Mode"
    new "Snabbt Överhoppningsläge"
...
translate swedish strings:
    ...
    new "Urklippsläsning aktiverat. Tryck 'shift+C' för att avaktivera."

    # renpy/common/00preferences.rpy:372
    old "Self-voicing enabled. Press 'v' to disable."
    new "Självläsning aktiverad. Tryck 'v' för att avaktivera."
...
translate swedish strings:
    ...
    new "Ren'Py Uppdateraren stöds inte på mobila enheter."
    ...
    new "Antingen så stöder inte detta projekt uppdatering eller så har uppdateringsstatusfilen raderats."

    # renpy/common/00updater.rpy:671
    old "This account does not have permission to perform an update."
    new "Detta konto har inte rättigheterna till att utföra en uppdatering."

    # renpy/common/00updater.rpy:674
    old "This account does not have permission to write the update log."
    new "Detta konto har inte rättigheterna till att skriva till uppdateringsloggen."

    # renpy/common/00updater.rpy:699
    old "Could not verify update signature."
    new "Kunde inte verifiera uppdateringssignaturen."

    # renpy/common/00updater.rpy:970
    old "The update file was not downloaded."
    new "Uppdateringsfilen blev inte nedladdad."

    # renpy/common/00updater.rpy:988
    old "The update file does not have the correct digest - it may have been corrupted."
    new "Uppdateringsfilen har inte rätt sammandrag - den kan ha blivit korrupt."
    ...
    new "Detta program har senaste uppdateringarna."

    # renpy/common/00updater.rpy:1406
    old "[u.version] is available. Do you want to install it?"
    new "[u.version] är tillgängligt. Vill du installera den?"

    # renpy/common/00updater.rpy:1408
    old "Preparing to download the updates."
    new "Förbereder nedladdning av uppdateringar."

    # renpy/common/00updater.rpy:1410
    old "Downloading the updates."
    new "Laddar ned uppdateringar."

    # renpy/common/00updater.rpy:1412
    old "Unpacking the updates."
    new "Packar upp uppdateringar."

    # renpy/common/00updater.rpy:1414
    old "Finishing up."
    new "Avslutar uppdatering."

    # renpy/common/00updater.rpy:1416
    old "The updates have been installed. The program will restart."
    new "Uppdateringarna har installerats. Programmet kommer startas om."
    ...
    new "Uppdateringen blev avbruten."
...
translate swedish strings:
    ...
    new "Höger-klicka eller Escape för att avsluta."

    # renpy/common/_developer/developer.rpym:425
    old "Rectangle copied to clipboard."
    new "Rektangel kopierades till urklipp."

    # renpy/common/_developer/developer.rpym:428
    old "Position copied to clipboard."
    new "Position kopierades till urklipp."
...
translate swedish strings:
    ...
    new "Inspekterar Stilar av [displayable_name!q]"
    ...
    new "        (inga egenskaper påverkar visningsbarheten)"

    # renpy/common/_developer/inspector.rpym:164
    old "        (default properties omitted)"
    new "        (standardegenskaper utelämnade)"
...
translate swedish strings:
    ...
    new "Försöker backa till en tidigare tidpunkt, vilket tillåter dig att spara eller välja ett annat val."
    ...
    new "Ignorerar undantaget, vilket tillåter dig att fortsätta. Detta leder ofta till ytterligare fel."
    ...
    new "Laddar om spelet från disk, sparar och återställer speltillstånd, om möjligt."

    # renpy/common/_errorhandling.rpym:540
    old "Open Traceback"
    new "Öppna återsökning"

    # renpy/common/_errorhandling.rpym:542
    old "Opens the traceback.txt file in a text editor."
    new "Öppnar traceback.txt filen i en textredigerare."

    # renpy/common/_errorhandling.rpym:545
    old "Copy to Clipboard"
    new "Kopiera till Urklipp"

    # renpy/common/_errorhandling.rpym:547
    old "Copies the traceback.txt file to the clipboard."
    new "Kopierar traceback.txt filen till urklipp."
    ...
    new "Analyserar den misslyckade källkoden."

    # renpy/common/_errorhandling.rpym:607
    old "Open Parse Errors"
    new "Öppna Analyserade Fel"

    # renpy/common/_errorhandling.rpym:609
    old "Opens the errors.txt file in a text editor."
    new "Öppnar errors.txt i en textredigerare."

    # renpy/common/_errorhandling.rpym:614
    old "Copies the errors.txt file to the clipboard."
    new "Kopierar errors.txt filen till urklipp."
...
# TODO: Translation updated at 2019-11-27 11:19
